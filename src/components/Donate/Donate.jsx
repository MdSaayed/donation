...
const Donate = ({ dtn }) => {
    const { id, title, picture, category, text_color, btn_bg, card_bg, donate_amount, category_bg } = dtn;
    ...
    return (
        <div style={cardStyle} className="grid grid-cols-6 items-center rounded-md gap-4">
            ...
            <div className="col-span-4 py-4">
                ...
                <div className="mt-2">
                    <Link  style={btnBg} className="text-white inline-block px-3 py-[3px] rounded" to={`/donation/${id}`}>View Details</Link>
                </div>
            </div>
        </div>
    );
